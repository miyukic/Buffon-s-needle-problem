...
class Bnp():
    ...
    def __init__(self):
        self.drop_point: Type(ndarray) = np.empty(0)  # 針の中心と線までの距離d
    ...
    def drop(self) -> None:
        ...
        self.drop_angle = np.append(Bnp.simulation(), self.drop_angle)  # 0°~180°
    ...
    def calc(self) -> float:
        print("回数:", len(self.drop_angle), sep = "")
        return len(self.drop_angle) / self.touch_line_count
